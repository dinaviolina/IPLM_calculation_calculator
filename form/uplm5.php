        ...
        <div class="wrapper mx-4">
            ...
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Form UPLM5</h2>
                </div> 
                <div class="card-body">
                    <form action="../proses/proses_uplm_5.php" method="POST">
                                ...
                                <div class="row row-space">
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="standar_kabkota">Jumlah Unit Perpustakaan Kabupaten/Kota Yang Dibina Sesuai Standar :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="standar_kabkota" required>                                          
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="standar_kec">Jumlah Unit Perpustakaan Kecamatan Yang Dibina Sesuai Standar :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="standar_kec" required>                                          
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="standar_desa">Jumlah Unit Perpustakaan Desa Yang Dibina Sesuai Standar :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="standar_desa" required>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-row" style="margin-top: 20px;">
                            ...
                            <div class="value">
                                <div class="row row-space">
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="standar_sdmi">Jumlah Unit Perpustakaan SD/MI Yang Dibina Sesuai Standar :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="standar_sdmi" required>
                                            
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="standar_smp">Jumlah Unit Perpustakaan SMP/MTS Yang Dibina Sesuai Standar :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="standar_smp" required>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="standar_sma">Jumlah Unit Perpustakaan SMA/SMK/MA Yang Dibina Sesuai Standar :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="standar_sma" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row row-space" style="margin-top: 20px;">
                                    ...
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="unit_sma">Jumlah Unit Perpustakaan SMA/SMK/MA :</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="row row-space">
                                    <div class="col-6">
                                        <div class="input-group-desc">
                                            <label for="standar_pt">Jumlah Unit Perpustakaan Perguruan Tinggi Yang Dibina Sesuai Standar :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="standar_pt" required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="input-group-desc">
                                            <label for="unit_pt" style="margin-top: 20px;">Jumlah Unit Perpustakaan Perguruan Tinggi :</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="row row-space">
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="standar_khusus">Jumlah Unit Perpustakaan Khusus Yang Dibina Sesuai Standar :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="standar_khusus" required>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="unit_p_khusus" style="margin-top: 20px;">Jumlah Unit Perpustakaan Khusus :</label>
