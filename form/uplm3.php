        ...
        <div class="wrapper mx-4">
            ...
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Form UPLM3</h2>
                </div> 
                <div class="card-body">
                    <!-- Awal Form -->
                    <form action="../proses/proses_uplm_3.php" method="POST">
                                ...
                                <div class="row row-space">
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="tenaga_kabkota">Jumlah Tenaga Perpustakaan Kab/Kota :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="tenaga_kabkota" required>                                          
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="tenaga_kec">Jumlah Tenaga Perpustakaan Kecamatan :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="tenaga_kec" required>                                          
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="tenaga_desa">Jumlah Tenaga Perpustakaan Desa :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="tenaga_desa" required>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-row" style="margin-top: 20px;">
                            ...
                            <div class="value">
                                <div class="row row-space">
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="tenaga_sdmi">Jumlah Tenaga Perpustakaan SD/MI :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="tenaga_sdmi" required>
                                            
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="tenaga_smp">Jumlah Tenaga Perpustakaan SMP/MTs :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="tenaga_smp" required>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="tenaga_sma"> Jumlah Tenaga Perpustakaan SMA/K/MA :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="tenaga_sma" required>
                                        </div>
                                    </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="row row-space">
                                    <div class="col-6">
                                        <div class="input-group-desc">
                                            <label for="tenaga_pt">Jumlah Tenaga Perpustakaan Perguruan Tinggi :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="tenaga_pt" required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="input-group-desc">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="row row-space">
                                    <div class="col-4">
                                        <div class="input-group-desc">
                                            <label for="tenaga_khusus">Jumlah Tenaga Perpustakaan Khusus :</label>
                                            <input class="input--style-5" style="margin-top: 5px;" type="decimal" name="tenaga_khusus" required>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group-desc">
